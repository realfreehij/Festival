...
abstract class Animal extends Creature implements Ageable{
	...
	protected function initEntity(){
		parent::initEntity();
		if(!isset($this->namedtag->Baby) || !($this->namedtag->Baby instanceof Byte)) $this->namedtag->Baby = new Byte("Baby", mt_rand(0, 5) == 0 ? self::DATA_FLAG_BABY : self::DATA_FLAG_NOTBABY);
