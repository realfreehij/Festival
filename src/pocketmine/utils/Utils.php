...
class Utils{
	...
	public static function randomUUID(){
		return Utils::toUUID(pack("N", time()) . pack("n", getmypid()) . pack("n", getmyuid()) . pack("N", mt_rand(-0x7fffffff, 0x7fffffff)) . pack("N", mt_rand(-0x7fffffff, 0x7fffffff)), 2);
	}
	 ...
	 * @param bool   $secure       default true, Generate secure distilled bytes, slower, unused
	 * @param bool   $raw          default true, returns a binary string if true, or an hexadecimal one
	 * @param string $startEntropy default null, adds more initial entropy, unused
	 * @param int    &$rounds      Will be set to the number of rounds taken, unused
	 * @param int    &$drop        Will be set to the amount of dropped bytes, unused
	 *
	 * @return string
	 */
